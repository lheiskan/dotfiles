  ...
  ...createHyperSubLayers({
    ...
    t: {
      ...
      h: {
        to: [
          {
            shell_command: `osascript /Users/lauri/github/dotfiles-latest/tmux/tools/tmux.scpt C-h`,
          },
        ],
      },
      // dotfiles-latest
      j: {
        to: [
          {
            shell_command: `osascript /Users/lauri/github/dotfiles-latest/tmux/tools/tmux.scpt C-u`,
          },
        ],
      },
      // watusy
      ...
      r: open("hammerspoon://daily-note"),
      // I tried to use apple script to trigger the command, but could not make it work
      // r: {
      //  to: [
      //     {
      //       shell_command: `osascript /Users/lauri/github/dotfiles-latest/tmux/tools/tmux.scpt 1`,
      //     },
      //   ],
      //  },
      // open karabiner rules.ts file
      e: open(
        "hammerspoon://karabiner-rules"
    ...
    s: {
      ...
      // Press the 'world key' (language selection)
      w: {
        to: [
          {
    ...
    u: {
      ...
      1: {
        to: [
          {
            shell_command: `/Users/lauri/.local/bin/yabai -m config layout stack`,
          },
        ],
      },
      2: {
        to: [
          {
            shell_command: `/Users/lauri/.local/bin/yabai -m config layout bsp`,
          },
        ],
      },
      3: {
        to: [
          {
            shell_command: `/opt/homebrew/bin/yabai -m config layout float`,
          },
        ],
      },
